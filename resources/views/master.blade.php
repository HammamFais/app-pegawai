            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start rtl:justify-end">
                    ...
                    <a href="{{ url('/') }}" class="flex ms-2 md:me-24">
                        ...
                        <span
                            class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">App
                            Pegawai</span>
                    </a>
                </div>
                <!-- Menu User (Dropdown) -->
                        ...
                        <div>
                            <button type="button"
                                ...
                                <img class="w-8 h-8 rounded-full"
                                    src="https://placehold.co/100x100/E2E8F0/334155?text=User" alt="user photo">
                            </button>
                        </div>
                ...
                <li>
                    <a href="{{ url('/settings') }}"
                        ...
                        <svg class="shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                            ...
                            viewBox="0 0 18 20">
                            <path
                                d="M18 11.022a1 1 0 0 0-1-1H9.62c-.31 0-.614.128-.832.355l-7 8.045a1 1 0 0 0 .734 1.635h13.956a1 1 0 0 0 .922-.632l2-5a1 1 0 0 0-.022-1.022Zm-2.08-.022H11.832c.111-.22.253-.429.422-.619l3.6-4.135a1 1 0 0 0-1.52-1.31L10.5 8.938c-.347.4-.518.882-.518 1.378v.006h4.01a1 1 0 0 0 .922-.632l1-2.5a1 1 0 0 0-1.844-.736l-1 2.5a1 1 0 0 0 .922.632h.022a1 1 0 0 0 .922-.632l1-2.5a1 1 0 1 0-1.844-.736l-1 2.5a1 1 0 0 0 .922.632h.022a1 1 0 0 0 .922-.632l1-2.5a1 1 0 1 0-1.844-.736l-1 2.5a1 1 0 0 0 .922.632ZM5.92 11H5a1 1 0 0 0 0 2h.92a1 1 0 0 0 0-2Z" />
                        </svg>
